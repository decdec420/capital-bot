...
const DEFAULT_BOT_SETTINGS: BotSettings = {
  ...
  compound_mode: true,
  paper_balance_usd: 50,
  paper_starting_balance_usd: 50,
  scale_in_enabled: true,
  scale_in_rsi_threshold: 22,
  scale_in_amount_usd: 5,
  max_buy_usd: 50,
};
...
const PRESETS = {
  loose: {
    label: "Loose",
    description: "More trades — good for warming up history",
    values: {
  ...
  balanced: {
    label: "Balanced",
    description: "Proven settings — deep oversold entries, 2% targets",
    values: {
      rsi_buy_threshold: 28,
      entry_score_threshold: 40,
      stop_loss_pct: 3,
  ...
  strict: {
    label: "Strict",
    description: "Fewer, highest-conviction entries with larger targets",
    values: {
      rsi_buy_threshold: 23,
